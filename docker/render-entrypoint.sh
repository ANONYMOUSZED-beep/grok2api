...
: "${GROK2API_ADMIN_USERNAME:=${GROK2API_BOOTSTRAP_ADMIN_USERNAME:-admin}}"
: "${GROK2API_ADMIN_PASSWORD:=${GROK2API_BOOTSTRAP_ADMIN_PASSWORD:-}}"
: "${GROK2API_ADMIN_PASSWORD:?GROK2API_ADMIN_PASSWORD or GROK2API_BOOTSTRAP_ADMIN_PASSWORD is required}"
: "${PORT:=8000}"
